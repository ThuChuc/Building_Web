...
<a href="/ctsp/insert" class="btn btn-success mt-5 mb-5">Insert</a>
<table class="table">
    <thead>
    <tr>
        <th>Id sản phẩm</th>
    ...
    <c:forEach items="${page.content}" var="s" varStatus="i">
        <tr>
            ...
            <td>${s.ngaySua}</td>
            <td>
                <a href="/ctsp/delete?id=${s.id}" class="btn btn-danger">Xoa</a>
                <a href="/ctsp/detail?id=${s.id}" class="btn btn-info">Chi tiet</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
