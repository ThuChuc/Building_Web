...
<a href="/san-pham/insert" class="btn btn-success mt-5 mb-5">Insert</a>
<table class="table">
    <thead>
    <tr>
        <th>STT</th>
    ...
    <c:forEach items="${page.content}" var="s" varStatus="i">
        <tr>
            ...
            <td>${s.ngayTao}</td>
            <td>${s.ngaySua}</td>
            <td>${s.danhMuc.maDanhMuc}</td>
            <td>${s.danhMuc.tenDanhMuc}</td>
            <td>
                <a href="/san-pham/delete?id=${s.id}" class="btn btn-danger">Xoa</a>
                <a href="/san-pham/detail?id=${s.id}" class="btn btn-info">Chi tiet</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
