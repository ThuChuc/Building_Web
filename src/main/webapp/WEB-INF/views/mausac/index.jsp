...
<h1>Day la trang mau sac</h1>
<a href="/mau-sac/insert" class="btn btn-success mt-5 mb-5">Insert</a>
<table class="table">
    <thead>
    <tr>
        <th>STT</th>
    ...
    <c:forEach items="${page.content}" var="s" varStatus="i">
        <tr>
            ...
            <td>${s.ngaySua}</td>
            <td>
                <a href="/mau-sac/delete?id=${s.id}" class="btn btn-danger">Xoa</a>
                <a href="/mau-sac/detail?id=${s.id}" class="btn btn-info">Chi tiet</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
